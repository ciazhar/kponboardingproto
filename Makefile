...
all: pagination customer_identity_verification customer_identity installment_category main

.PHONY: pagination customer_identity_verification customer_identity installment_category main all
